...
import { peak, type TrendPoint } from '@/lib/trend';

// A bar chart of activity over time, in plain SVG.
//
// No charting library on purpose. An app that has to stay installable on a
...
//     that hides that invites a board to read a Tuesday as a decline.
