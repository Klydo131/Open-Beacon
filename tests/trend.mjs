...
// a decline, and a percentage change with nothing to divide by. A board
...
import { trend, momentum, peak, quietCount } from '../lib/trend.ts';
...
ok(
  ...
  'and so does a chart of an entirely quiet week',
);
ok(
  peak([
